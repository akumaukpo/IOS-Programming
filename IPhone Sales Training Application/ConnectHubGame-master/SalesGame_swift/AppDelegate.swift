...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("wM9NKFiLLUzg5o3hZ9G05GBwN1vRlFkowzMNHWn5", clientKey:"QqwsxVf2pMMQyA7OYxCeb3fdKCvJGbaR8R5roUz8")
        
        // Customize navigation bar for every screen globally
        UINavigationBar.appearance().barTintColor = UIColor(red: 244.0/255.0, green: 128.0/255.0, blue: 31.0/255.0, alpha: 1.0)
